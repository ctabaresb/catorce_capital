...
def main():
    ...
    # v5: respect locked-scope split. Default caps sweep at Apr 5 so Apr 6-13
    # stays clean for val/holdout/reserve evaluation downstream.
    ap.add_argument("--train_end_date", type=str, default="2026-04-05",
