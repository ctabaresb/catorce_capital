# bitso-orderbook-fetch  (LEGACY -- DEPRECATED)
...
| Last modified | 2026-01-30T17:16:15.000+0000 |
...
2. Upload to Lambda: `aws lambda update-function-code --function-name bitso-orderbook-fetch --zip-file fileb://function.zip`
