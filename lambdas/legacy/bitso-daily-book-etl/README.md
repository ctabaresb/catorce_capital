# bitso-daily-book-etl  (LEGACY -- DEPRECATED)
...
| Last modified | 2025-11-14T21:54:47.000+0000 |
...
2. Upload to Lambda: `aws lambda update-function-code --function-name bitso-daily-book-etl --zip-file fileb://function.zip`
